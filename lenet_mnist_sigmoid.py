...
if __name__ == '__main__':
	...
	writer=SummaryWriter(comment='lenet_mnist_sigmoid_0.1')
	net=Net()
	print(type(net))
	print(net)
	...
	for epoch in range(epoch_num):
        ...
        # loss 是一个scalar,需要使用loss.item()来获取数值，不能使用loss[0]
			...
			if i % 50 == 49: # 每50个batch打印一下训练状态
				...
				writer.add_scalar('scalar/sigmoid_running_correct',(100.0*correct.float()/total), idx)
				correct = 0 
				total = 0
		total=0
		correct=0
		if epoch%2==0:
			...
			with t.no_grad():
				...
				writer.add_scalar('scalar/sigmoid_test_correct',(100.0*correct.float()/total), idc)
